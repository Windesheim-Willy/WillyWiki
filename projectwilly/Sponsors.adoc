...
with. After creating a foam mould, we drove it to Koers in Nieuwleusen
and made the outer skin of Willy from fibreglass.

image:media/koers.png[image,width=300]
