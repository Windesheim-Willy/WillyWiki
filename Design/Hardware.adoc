...
image:media/hardware/Connections.PNG[image]
...
image:media/hardware/connector.png[image]
...
image:media/hardware/batteries_old.png[image,width=500]

image:media/hardware/battery_old.jpg[image,width=500]
...
image:media/hardware/batteries_new.png[image,width=500]

image:media/hardware/battery_new.jpg[image,width=500]
...
image:media/hardware/sensor_willy.jpg[image]
...
image:media/hardware/Sonar.PNG[image]
...
image:media/hardware/Willy.png[image]
