...
image::media/rosgraph-camera.png[]
...
image::media/rosgraph-pointcloud-to-scan.png[]
...
image::media/rosgraph-sonar.png[]
...
image::media/rosgraph-move_base.png[]
...
image::media/rosgraph-amcl.png[]

=== Map

image::media/rosgraph-map.png[]