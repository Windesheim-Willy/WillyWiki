...
image:media/rosgraph.png[image, width=500]
...
image:media/rosgraph-pointcloud-to-scan.png[image, width=500]
...
image:media/rosgraph-sonar.png[image, width=500]
...
image:media/rosgraph-move_base.png[image, width=500]
...
image:media/rosgraph-amcl.png[image, width=500]
