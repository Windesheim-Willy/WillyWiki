...
|ping  |-  | 
Ping lets you test whether or not a node is running or if you're connected to the network. For best results, you use an IP Address e.g. `192.168.0.1` for WTR's Router Node.
|dmesg  |-  |
