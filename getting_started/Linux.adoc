...
=== Command Aliases
Certain commands often wind up to be too long to repeat every so often. For this, the command line interface allows you to configure aliases for frequently used commands.
