...
== ROS topics
These are the topics at the ROS master of Willy. There are several communication protocols defined in ROS, but in Willy only topics are used. The topics are shown in the next table.
